...
data = dataloader.load_data(option = "train_min", type = "iter", domain = "yelp", level = 0)
data += dataloader.load_data(option = "train_min", type = "iter", domain = "yelp", level = 1)
data += dataloader.load_data(option = "train_min", type = "iter", domain = "yelp", level = 2)
data += dataloader.load_data(option = "train_min", type = "iter", domain = "yelp", level = 3)
data += dataloader.load_data(option = "train_min", type = "iter", domain = "yelp", level = 4)
labels = [0] * 150 + [1] * 600
...
with open("gpt_iter_yelp_train_min_01234.json", "w", encoding="utf-8") as f:
