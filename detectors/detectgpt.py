...
data = dataloader.load_data(option = "train_min", type = "iter", domain = "xsum", level = 0)
data += dataloader.load_data(option = "train_min", type = "iter", domain = "xsum", level = 1)
data += dataloader.load_data(option = "train_min", type = "iter", domain = "xsum", level = 2)
data += dataloader.load_data(option = "train_min", type = "iter", domain = "xsum", level = 3)
data += dataloader.load_data(option = "train_min", type = "iter", domain = "xsum", level = 4)
labels = [0] * 150 + [1] * 600
...
with open("gpt_iter_xsum_train_min_01234.json", "w", encoding="utf-8") as f:
